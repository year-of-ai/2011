...
1. **Organizational inertia**: Despite inventing digital photography, Kodak's organizational culture, compensation structures, and managerial incentives were tied to film profitability, making it structurally difficult to cannibalize the core business.

2. **The smartphone effect**: Kodak's collapse coincided precisely with the rise of smartphone cameras — the iPhone's camera (2007) and Android ecosystem growth — which displaced not only film cameras but dedicated digital cameras as the mass-market format. By 2012, smartphones were the dominant consumer photography device.

3. **Regional economic impact**: Kodak's decline devastated Rochester's economy in a manner that became a template for understanding how anchor employers shape regional economic resilience. Rochester's GDP and employment figures tracked Kodak's decline closely through the 2000s and 2010s.

## Related

<!-- BEGIN GENERATED: crossrefs — maintained by build-structure; do not edit by hand -->
- [Microsoft Acquires Skype (May 10, 2011)](skype-microsoft-acquisition-2011.md) — A contrasting 2011 story of corporate transformation: while Kodak fell by failing to acquire and integrate digital-era assets, Microsoft paid $8.5 billion to position itself in digital communication
- [Occupy Wall Street (September 2011)](occupy-wall-street.md) — The simultaneous protest movement, partly fueled by manufacturing and middle-class job losses of the type Kodak's collapse exemplified
- [iPhone 4S & Siri Introduction (October 2011)](../science-technology/iphone-4s-siri.md) — The product category — smartphone cameras — whose growth during 2011 represented the final stage of the consumer-photography transition that made Kodak's core business obsolete
<!-- END GENERATED: crossrefs -->

## Sources

- [Kodak — Wikipedia](https://en.wikipedia.org/wiki/Kodak)
- [Eastman Kodak Files for Bankruptcy — The New York Times (January 19, 2012)](https://www.nytimes.com/2012/01/20/business/eastman-kodak-files-for-bankruptcy.html)
- [How Kodak Failed — Forbes (January 18, 2012)](https://www.forbes.com/sites/chunkamui/2012/01/18/how-kodak-failed/)
- [The First Digital Camera — Steven Sasson, Kodak (1975) — IEEE Spectrum](https://spectrum.ieee.org/the-first-digital-camera-as-explained-by-its-inventor)
- [The Innovator's Dilemma — Clayton M. Christensen (1997), Harvard Business School Press](https://www.hbs.edu/faculty/Pages/item.aspx?num=46)
