...
The failure stood in stark contrast with simultaneous American successes: in 2011 the MESSENGER spacecraft entered Mercury orbit for the first time (see [MESSENGER Mercury Orbit](messenger-mercury-orbit.md)) and NASA's [Curiosity rover](nasa-curiosity-rover.md) launched on November 26, 2011, just 18 days after Phobos-Grunt, successfully reaching Mars in August 2012. The same year also saw the final [Space Shuttle mission](space-shuttle-final-mission.md), marking a generational transition in American space exploration priorities.
...
- [MESSENGER Enters Orbit Around Mercury (March 18, 2011)](messenger-mercury-orbit.md) — NASA's successful Mercury orbital insertion in 2011, a contrast in planetary-science fortunes
- [NASA Curiosity Rover Launch (November 26, 2011)](nasa-curiosity-rover.md) — NASA's Mars Science Laboratory, launched 18 days later, succeeded where Phobos-Grunt failed
- [Space Shuttle Program Ends (July 21, 2011)](space-shuttle-final-mission.md) — the concurrent end of the Shuttle era marked 2011 as a year of major space transitions
- [Faster-Than-Light Neutrino Anomaly (September 23, 2011)](faster-than-light-neutrino-anomaly-2011.md) — another 2011 science story that captured international attention
<!-- END GENERATED: crossrefs -->

## Sources

- [Fobos-Grunt - Wikipedia](https://en.wikipedia.org/wiki/Fobos-Grunt)
- [Phobos-Grunt Failure Report Released | The Planetary Society](https://www.planetary.org/articles/3361)
- [Phobos-Grunt | Russian mission, Mars probe, interplanetary flight | Britannica](https://www.britannica.com/topic/Phobos-Grunt)
- [In Depth | Phobos-Grunt – NASA Solar System Exploration](https://solarsystem.nasa.gov/missions/phobos-grunt/in-depth/)
- [Yinghuo-1 - Wikipedia](https://en.wikipedia.org/wiki/Yinghuo-1)
- [Living Interplanetary Flight Experiment - The Planetary Society](https://www.planetary.org/projects/life)
