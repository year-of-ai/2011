...
The disaster reshaped global nuclear governance, prompted revisions to IAEA safety standards, and reinvigorated debates about nuclear energy that continued through the 2020s. It also occurred within a year that included the [Arab Spring](../history-politics/arab-spring.md) uprisings and the end of the [Space Shuttle program](space-shuttle-final-mission.md)—a convergence of events that marked 2011 as a year of profound institutional stress-testing around the world.
